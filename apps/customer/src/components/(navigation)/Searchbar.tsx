...
function Searchbar({ setNavVisible }: { setNavVisible: (value: boolean) => void }) {
    ...
    return (
        <div className='flex justify-between items-center px-4 py-4 md:px-5 lg:px-20 xl:px-32 bg-background text-gray-700 md:bg-background  md:border-b md:border-border'>
            ...
            <div className='hidden md:flex items-center gap-2 border border-border rounded-md w-full flex-1 pl-2 md:ml-2 basis-1/4'>
                <Image src='/search.svg' alt='search' width={20} height={20} className='text-gray-700' />
                <input type="text" placeholder='Search for products' className='outline-none flex-1 bg-background text-foreground' />
            ...
            <div className='flex items-center gap-[2px] flex-1 justify-end'>
                <Link href="/profile/235" className='md:px-1 lg:px-2 md:border-r md:border-border'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                    </svg>
                </Link>
                <Link href="/wishlist" className='lg:px-1'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                    </svg>
                </Link>
                <div className='flex items-center gap-2 relative '>
                    <Link href='/cart' className='flex items-center gap-2 relative md:border-l md:border-border md:pl-1'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
