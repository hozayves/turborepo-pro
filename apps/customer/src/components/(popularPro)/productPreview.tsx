...
import AdjustQty from "../wishlist/adjustQty";
import InputButton from "../ui/form/button";


export default function ProductPreview() {
    return (
        <div className="flex flex-col gap-10 md:flex-row md:px-5" >
            <div className="flex flex-col gap-2 md:flex-1 md:flex-row md:items-center">
                ...
                <div className="flex gap-1 justify-center md:order-1">
            ...
            <div className="flex flex-col gap-1 md:flex-1 md:px-3">
                ...
                <div className="flex flex-col gap-1 pt-2 text-base border-t border-gray-100">
